...
# Reference Tutorial: https://www.youtube.com/watch?v=S0nAJ_1VgCw
# Editorial: https://discuss.codechef.com/t/ddimmst-editorial/79385
        ...
        for index, point in enumerate(points):
            ...
            for bit, p in zip(mask, point):
                if bit == '1':
                    ...
                    s -= p
            mask_edge_weights.push((s, index))
