...
def solve(n):
    ...
    for _ in range(n):
        chef_pick, morty_pick = Input.array_integer()
        digit_sum_chef_pick = digit_sum(chef_pick)
        digit_sum_morty_pick = digit_sum(morty_pick)
        if digit_sum_chef_pick > digit_sum_morty_pick:
            chef += 1
        elif digit_sum_chef_pick < digit_sum_morty_pick:
            morty += 1
        else:
            chef += 1
            morty += 1
